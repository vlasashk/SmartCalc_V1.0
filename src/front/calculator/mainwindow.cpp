...
MainWindow::MainWindow(QWidget *parent)
    ...
    connect(ui->pushButton_backspace, SIGNAL(clicked()), this, SLOT(backspaceInputLine()));
    connect(ui->pushButton_equal, SIGNAL(clicked()), this, SLOT(sendToCalculate()));
    connect(ui->pushButton_switch, SIGNAL(clicked()), this, SLOT(switchInputField()));
    connect(ui->pushButton_plot, SIGNAL(clicked()), this, SLOT(callPlotModule()));

    connect(blinkTimer, &QTimer::timeout, this, &MainWindow::toggleLabelVisibility);
    connect(blinkDurationTimer, &QTimer::timeout, this, &MainWindow::stopBlinking);
